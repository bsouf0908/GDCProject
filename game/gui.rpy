...
define gui.name_text_font = "gui/fonts/Minecraft.ttf"
...
define gui.main_menu_background = Movie(play="gui/main_menu.ogv", size=(1280, 720), loop=True)
...
define gui.dialogue_ypos = 88#50 then to #90

...
image phone = "gui/ingame_smartphone/phone.png"
...
define config.name = _("Synergist")
...
define first_two_days = ['audio/music/1.mp3', 'audio/music/2.mp3', 'audio/music/3.mp3', 'audio/music/4.mp3']

init python:
    renpy.random.shuffle(first_two_days)
    
define config.main_menu_music = first_two_days
...
define config.save_directory = "Synergist-1604095998"

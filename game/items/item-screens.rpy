...
screen gold_count():
    ...
    frame xsize 200:
        ...
        label _("Shekels {image=images/shekel.png}")
        #add "money icon"
...
screen inventory(collection, selling=False):
    ...
    if selling:
        ...
        label _("Backpack") style "special_label" align (.1,.05)
    ...
    textbutton _("Return") action [Return(), Show("overlay", transition=Dissolve(0.2)), Hide("inventory", transition=Dissolve(0.2))] style "offset_return_button" yalign .98
    #window show

    #action Narrator "You put away your backpack."
...
screen reward(itemdrop, get=True):
    ...
    vbox at reward_appear:
        ...
        if get:
            text "GET!" xalign .5 yoffset 10 size 36

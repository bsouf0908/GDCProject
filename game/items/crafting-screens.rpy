...
screen recipes():
    ...
    textbutton _("Return") yalign .98 action [Return(), Show("overlay", transition=Dissolve(0.2)), Hide("recipes", transition=Dissolve(0.2))] style "offset_return_button"

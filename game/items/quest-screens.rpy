...
screen quests(page=0):
    ...
    textbutton _("Return") yalign .98 action [Return(), Show("overlay", transition=Dissolve(0.2)), Hide("quests", transition=Dissolve(0.2))] style "offset_return_button"
            ...
            if page==0:
                vbox:
                    ...
                    hbox:
                        ...
                        text "[quest.reward] "
                        text _(u"Shekels {image=images/shekel.png}")
